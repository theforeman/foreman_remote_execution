      ...
      app.reloader.to_prepare do
        Foreman::Plugin.register :foreman_remote_execution do
          ...
          security_block :foreman_remote_execution do
            ...
            permission :view_job_invocations, { :job_invocations => [:index, :chart, :show, :auto_complete_search, :preview_job_invocations_per_host], :template_invocations => [:show, :show_template_invocation_by_host, :list_jobs_hosts],
                                                'api/v2/job_invocations' => [:index, :show, :output, :raw_output, :outputs, :hosts] }, :resource_type => 'JobInvocation'
            permission :view_template_invocations, { :template_invocations => [:show, :template_invocation_preview, :show_template_invocation_by_host, :list_jobs_hosts],
